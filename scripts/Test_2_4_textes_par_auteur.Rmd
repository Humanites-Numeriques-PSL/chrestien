...
```{r}
library("tm")
corpus = VCorpus(DirSource("corpus/test2", encoding = "UTF-8"), readerControl = list(language = "fra"))
...
Not exactly… 
```{r}
folder_path <- "corpus/corpus/test2"
...
```{r}
samples = VCorpus(DirSource("corpus/test2", encoding = "UTF-8"), readerControl = list(language = "fra"))
