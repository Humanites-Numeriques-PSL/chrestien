...
```{r}
library("tm")
corpus = VCorpus(DirSource("corpus/test1_2 8 textes par auteur", encoding = "UTF-8"), readerControl = list(language = "fra"))
...
Not exactly… 
```{r}
folder_path <- "corpus/corpus/test1_2 8 textes par auteur"
...
```{r}
samples = VCorpus(DirSource("corpus/test1_2 8 textes par auteur", encoding = "UTF-8"), readerControl = list(language = "fra"))
